...
/**
 * Created by vishaljasrotia on 30/05/17.
 */
...
public class AnimationView extends View {
    ...
    public void setAniBackColor(int color) {
        mBackPaint.setColor(Color.parseColor("#00112233"));
    }

    public void setAniForeColor(int color) {
        mBallPaint.setColor(Color.parseColor("#F57C00"));
        mOutPaint.setColor(Color.parseColor("#F57C00"));
        setBackgroundColor(Color.parseColor("#00112233"));
    }
