...
public  class BookMarkAdapter extends BaseAdapter {
    ...
    private BookMarkActivity Callback               = null;
    ...
    public BookMarkAdapter(BookMarkActivity Callback, Context context, List<Object> productsList, List<NewsStory> allNewslist, boolean loadImages, String sourceName) {
...
//                final BookMarkAdapter.AdViewHolder adViewHolder;
//                if(convertView == null) {
//                    adViewHolder = new BookMarkAdapter.AdViewHolder();
...
//                }else{
//                    adViewHolder = (BookMarkAdapter.AdViewHolder) cell.getTag();
//                }
//
//                BookMarkAdapter.LoadAdAsync loadAd = new BookMarkAdapter.LoadAdAsync(adViewHolder.adView);
//                loadAd.execute();
//                break;
//
//
...
//                cell = (FoldingCell) convertView;
//                final BookMarkAdapter.ViewHolder viewHolder ;
//
//                if(convertView == null) {
//
...
//                        cell.fold(true);
//                    }
//                    viewHolder = (BookMarkAdapter.ViewHolder) cell.getTag();
//                }
